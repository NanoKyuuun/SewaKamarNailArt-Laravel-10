                        ...
                        <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                            <div>
                                ...
                                <div class="rounded-lg bg-white p-8 shadow-lg lg:col-span-3 lg:p-12">
                                    <form action="/dashboard/pembayaran/{{ $edit_pembayaran->id }}" class="space-y-4" method="POST" enctype="multipart/form-data">
                                        @method('put')
                                        @csrf
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <input class="w-full rounded-lg border-gray-200 p-3 text-sm"
                                                ...
                                                value="{{ $edit_pembayaran->id }}" readonly/>
                                        </div>
                                        <div>
                                            ...
                                            <input class="w-full rounded-lg border-gray-200 p-3 text-sm"
                                                ...
                                                value="{{ $edit_pembayaran->pembayaran->tanggal_pembayaran }}" />
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <input class="w-full rounded-lg border-gray-200 p-3 text-sm"
                                                ...
                                                value="{{ $edit_pembayaran->pembayaran->no_rekening }}" />
                                        </div>
                                        <div>
                                            <label class="sr-only" for="tipe">harga pembayaran</label>
                                            <input class="w-full rounded-lg border-gray-200 p-3 text-sm"
                                                placeholder="Tipe" type="text" id="tipe" name="harga_pembayaran"
                                                value="{{ $kamar[0]->harga }}"  readonly/>
                                        </div>
                                        <div>
                                            <label class="" for="tipe">Bukti Pembayaran</label>
                                            @if($edit_pembayaran->bukti_pembayaran)
                                                <img src="{{ asset('storage/public/bukti_pembayaran/' . $edit_pembayaran->pembayaran->bukti_pembayaran) }}" alt="Bukti Pembayaran" style="max-height: 200px"/>
                                            @else
                                                <input class="w-full rounded-lg border-gray-200 p-3 text-sm"
